...
$(function() {
    if( wgAction == "purge" && getParamValue("auto") == 1 && document.forms[0] && document.forms[0].elements["submit"] ) {
...
$(function() {
    ...
    if (formDiv) {
        ...
        formObj.setAttribute( "action" , wgServer+"/w/index.php?title=" + encodeURIComponent( wgPageName ) + "&action=purge" );
