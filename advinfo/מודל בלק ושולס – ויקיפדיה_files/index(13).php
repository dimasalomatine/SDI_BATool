...
function getRandomTip() {
 ...
 navTipContent[6] = '<a href="/wiki/%D7%95%D7%99%D7%A7%D7%99%D7%A4%D7%93%D7%99%D7%94:%D7%A0%D7%99%D7%95%D7%95%D7%98" title="ויקיפדיה:ניווט">בדף הזה</a> תוכלו למצוא מגוון של דרכים בהן תוכלו למצוא את המידע שאתם מחפשים.';
...
function addNavTip() {
    ...
    var navTipTitle = document.createElement('H5');
...
if ( !wgUserName ) addOnloadHook(addNavTip);  // for anon only